...
export default function Home2({ match, history }) {
    ...
    let selectedCategory=match?.params?.category?match?.params?.category:""
    ...
    useEffect(() => {
        ...
        dispatch(getProducts("", currentPage, price, selectedCategory, rating))


    }, [dispatch, alert, error, selectedCategory, currentPage, price, category, rating])
    ...
    return (
        <>
            {loading ? <>
                ...
                <>
                    <MetaData title={selectedCategory ? selectedCategory : "Buy Best Product Online"} />
                    {(!selectedCategory) &&
                        <>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-3" style={{ padding: 0, }} onClick={() => history.push(`/search/Electronics`)}>
                                    ...
                                    <div class="col-md-3" style={{ padding: 0 }} onClick={() => history.push(`/search/Cameras`)}>
                                        <div class="card" style={{ textAlign: 'center' }}>
                                    ...
                                    <div class="col-md-3" style={{ padding: 0 }} onClick={() => history.push(`/search/Laptops`)}>
                                        <div class="card" style={{ textAlign: 'center' }}>
                                    ...
                                    <div class="col-md-3" style={{ padding: 0 }} onClick={() => history.push(`/search/Accessories`)}>
                                        <div class="card" style={{ textAlign: 'center' }}>
                                    ...
                                    <div class="col-md-3" style={{ padding: 0 }} onClick={() => history.push(`/search/Headphones`)}>
                                        <div class="card" style={{ textAlign: 'center' }}>
                                    ...
                                    <div class="col-md-3" style={{ padding: 0 }} onClick={() => history.push(`/search/Food`)}>
                                        <div class="card" style={{ textAlign: 'center' }}>
                                    ...
                                    <div class="col-md-3" style={{ padding: 0 }} onClick={() => history.push(`/search/Books`)}>
                                        <div class="card" style={{ textAlign: 'center' }}>
                                    ...
                                    <div class="col-md-3" style={{ padding: 0 }} onClick={() => history.push(`/search/Sports`)}>
                                        <div class="card" style={{ textAlign: 'center' }}>
                                    ...
                                    <div class="col-md-3" style={{ padding: 0 }} onClick={() => history.push(`/search/Outdoor`)}>
                                        <div class="card" style={{ textAlign: 'center' }}>
                                    ...
                                    <div class="col-md-3" style={{ padding: 0 }} onClick={() => history.push(`/search/Home`)}>
                                        <div class="card" style={{ textAlign: 'center' }}>
